...
## Prompt
    ...
    - Background: Recently retired; Married long-term; Adult children nearby; Caregiver for sibling
    ...
    - Recent Triggers and Stressors: Debt collection calls; Rising rent; Car repair bill; Poor sleep; Recent ageist comments
    ...
    - A clinician wrote this to capture how this user might authentically express their situation: I've been feeling kind of on edge with these bills coming in, the rent going up and the car repair, and it's hard to sleep sometimes, not sure if it's worth bringing up though.
