...
## Prompt
    ...
    - Background: Remote tech job; Lives alone; Close sister nearby; Weekend social drinking; Perfectionistic self-standards
    ...
    - Diagnoses and Symptoms: Substance use-related symptoms (problematic alcohol or drug use impacting mood, behavior, sleep, or functioning) | Obsessive / intrusive thought patterns (intrusive thoughts, mental rituals, rigidity, moral or contamination concerns, reassurance-seeking; may include compulsions)
    ...
    - Recent Triggers and Stressors: Work deadline surge; Sleep getting worse; Drinking more nights; Avoiding friends; Rising grocery bills
    ...
    - A clinician wrote this to capture how this user might authentically express their situation: I'm prob overreacting, but my brain keeps looping on the same “what if I messed up?” thoughts, and I’ve been drinking most nights to shut it off which works for a while but then doesn't when i'm hungover and the next day
